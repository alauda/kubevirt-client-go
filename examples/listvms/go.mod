...
require (
	github.com/alauda/kubevirt-client-go v1.5.2-alauda
...
require (
	...
	kubevirt.io/api v0.0.0-20250610171447-0886d74864b6 // indirect
...
replace (
	...
	modernc.org/ccgo/v3 => modernc.org/ccgo/v3 v3.0.0
)
